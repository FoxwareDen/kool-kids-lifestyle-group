      ...
      {SLIDES.map((slide, i) => (
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(160deg, rgba(12,26,51,0.9) 0%, rgba(12,26,51,0.55) 45%, rgba(12,26,51,0.25) 100%)',
            }}
          />
        </div>
      ))}
        ...
        {SLIDES.map((slide, i) => (
          <button
            ...
            style={{
              ...
              background:
                i === active ? 'var(--brand-orange)' : 'rgba(255,255,255,0.4)',
            }}
          />
        ))}
      </div>
...
function RouteComponent() {
  ...
  return (
    <div
      ...
      style={{ background: 'var(--foam)', fontFamily: 'var(--font-sans)' }}
    >
      <div
      ...
      >
        ...
        <h1
          className="display-title text-3xl font-semibold leading-tight text-balance mt-24 rounded-lg z-50"
