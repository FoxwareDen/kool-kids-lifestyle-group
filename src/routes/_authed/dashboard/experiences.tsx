      ...
      {error ? (
        <div className="mt-12 flex flex-col items-center justify-center gap-3 border border-dashed border-(--brand-navy)/20 bg-white/60 py-20 text-center">
          ...
          <p className="max-w-sm text-sm text-[var(--brand-navy)]/55">
            Something went wrong while fetching experiences. Please refresh the
            page to try again.
          </p>
        </div>
      ) : filtered.length === 0 ? (
        <div className="mt-12 flex flex-col items-center justify-center gap-3 border border-dashed border-(--brand-navy)/20 bg-white/60 py-20 text-center">
          ...
          <p className="max-w-sm text-sm text-[var(--brand-navy)]/55">
            There are no experiences in this category right now. Check back soon
            or browse all of our adventures.
          </p>
        </div>
      ) : (
            ...
            <div key={experience.id} className="relative">
              <div className="absolute z-30 top-0 right-0 px-2.5 py-2.5">
                <button
                  ...
                  className="rounded-full bg-[var(--destructive-foreground)]/65 hover:bg-[var(--destructive)]/90 hover:scale-110 px-0.5 py-1 text-white backdrop-blur-sm"
                >
