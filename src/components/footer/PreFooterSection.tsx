...
const data: Record<string, Translatable> = {
  ...
  explore_description: {
    ...
    translations: {
      af: 'Of jy nou avontuur, erfenis, ontspanning of ontdekking soek — jou volgende belewenis begin hier.',
    },
  },
}
...
const TESTIMONIALS: { quote: Translatable; author: string }[] = [
  {
    quote: {
      ...
      translations: {
        af: "Prieska het al ons verwagtinge oortref. Die mense, die landskap en die stories maak dit 'n werklik besondere plek.",
      },
    },
  ...
  },
  {
    quote: {
      ...
      translations: {
        af: "'n Verborge juweeltjie in die Noord-Kaap. Ons het elke oomblik op die rivier en by die erfenisplekke geniet.",
      },
    },
  ...
  },
  {
    quote: {
      ...
      translations: {
        af: 'Warm gasvryheid en onvergeetlike sonsondergange. Ons beplan al ons volgende besoek aan Prieska.',
      },
    },
