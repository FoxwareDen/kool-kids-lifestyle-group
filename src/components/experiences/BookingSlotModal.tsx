...
import { Calendar, Check, Clock, CreditCard, Lock, Plus, Trash2, Users, X } from 'lucide-react'
import {
  generateSlots,
  formatDayLabel,
  slotRemaining,
...
/** A single selected booking line: date + time + unit. */
...
/**
 * Booking modal for an experience. Visitors can build up a cart of slot
 * selections across multiple days, then proceed to a (design-only) payment
 * window. No payment is actually processed.
 */
