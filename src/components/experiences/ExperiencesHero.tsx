...
/**
 * The page hero for the "/experiences" route. Displays a full-width background
 * image behind navy readability overlays, the shared {@link SiteHeader}, a
 * breadcrumb trail, an orange eyebrow, a serif headline and a script-styled
 * subtitle. Mirrors the visual language of the Heritage and About heroes for a
 * consistent secondary-page format.
 *
 * @returns {JSX.Element} The rendered experiences hero section.
 */
export function ExperiencesHero() {
  return (
    <section className="relative flex min-h-[60svh] w-full items-end overflow-hidden bg-[var(--brand-navy)] pb-14">
      {/* Background image */}
      <img
        src="/images/sections/quad.png"
        alt="Adventurers exploring the Karoo landscape around Prieska"
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1180px] px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="display-title mt-3 max-w-3xl text-balance text-4xl font-medium leading-[1.1] text-white sm:text-5xl lg:text-[3.5rem]">
          Unforgettable Experiences in Prieska
        </h1>
